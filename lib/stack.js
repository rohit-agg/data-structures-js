 ...
 *  @description
 *  <ul>
 *      <li>Synonym for push method, invokes the same to perform the necessary task</li> 
 *  </ul>
 */
Stack.prototype.insert = function(pObject, pCallback) {
    
    // Calls the push function to execute the desired functionality
    this.push(pObject, pCallback);
}
 ...
 *  @description
 *  <ul>
 *      <li>Synonym for pop method, invokes the same to perform the necessary task</li> 
 *  </ul>
 */
