...
LinkedList.prototype.deleteEnd = function() {
    ...
    if (typeof parentNode !== "undefined")      parentNode.setNext(undefined);
...
LinkedList.prototype.deleteAt = function(pLocation) {
    ...
    if (typeof parentNode !== "undefined")                  parentNode.setNext(currentNode.getNext());
    
    // If the parent node is undefined, update the head to point to next of current node
    if (typeof parentNode === "undefined")                  this.head = currentNode.getNext();
    
    // If the next node of current node is undefined, update the tail of list to parent node
    if (typeof currentNode.getNext() === "undefined")       this.tail = parentNode;
 ...
 *  @description
 *  <ul>
 *      <li>Returns the size of the linked list, ie number of elements in Linked List</li>
 *  </ul>
 */
LinkedList.prototype.size = function() {
    
    return this.size                    // Returns the size of linked list
}
