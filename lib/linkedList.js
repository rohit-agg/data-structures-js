...
LinkedList.prototype.insertEnd = function(pData, pCallback) {
    ...
    if (typeof this.tail !== "undefined") {
        // If there is a node in the end of the list, set the next of the last node to the new node

        this.tail.next = newListNode;           // Update the next Node of End to point to newly created Node
    }
...
LinkedList.prototype.removeFront = function() {
    ...
    var frontData = this.head.data;             // Store data in front of linked list into a temporary variable
...
LinkedList.prototype.removeEnd = function() {
    ...
    if (this.head == this.tail && typeof this.head === "undefined") {
        // If the linked list is empty, return "undefined"
    
        return undefined;
    }
    
    var endData = this.tail.data;           // Store data in end of linked list into a temporary variable
    ...
    while (typeof currentNode.next !== "undefined") {
...
LinkedList.prototype.toString = function() {
    ...
    if (typeof current !== "undefined") {
        ...
        // Add the data in the first node to the string, and advance the pointer
