...
DoublyLinkedList.prototype.insertFront = function(pData, pCallback) {
    ...
    if (typeof this.head !== "undefined") {
        // If head is a proper doubly list node

        this.head.prev = newDoublyListNode;         // Set new node as previous of current head of linked list
    }
...
DoublyLinkedList.prototype.insertEnd = function(pData, pCallback) {
    ...
    if (typeof this.tail !== "undefined") {
        // If the tail is a proper doubly list node

        this.tail.next = newDoublyListNode;         // Update the next Node of End to point to newly created Node
    }
...
DoublyLinkedList.prototype.insertAt = function(pData, pLocation, pCallback) {
    ...
    while (location < pLocation) {
        ...
        currentNode = currentNode.next;                 // Update the current node to point to next node
    ...
    if (typeof parentNode !== "undefined") {
        ...
        parentNode.next = newDoublyListNode;
    }
    ...
    if (typeof currentNode !== "undefined") {
        ...
        currentNode.prev = newDoublyListNode;
    }
...
DoublyLinkedList.prototype.removeFront = function() {
    ...
    var frontData = this.head.data;             // Store data in front of doubly linked list into a temporary variable
    var frontOfList = this.head.next;           // Store the new front of list into a temporary variable
    ...
    this.head.prev = undefined;         // Set the previous node of the head to undefined
...
DoublyLinkedList.prototype.removeEnd = function() {
    ...
    var endData = this.tail.data;           // Store data in end of doubly linked list into a temporary variable
    var endOfList = this.tail.prev;         // Store the new end of the list into a temporary variable
    ...
    this.tail.next = undefined;         // Set the previous node of the head to undefined
...
DoublyLinkedList.prototype.removeAt = function(pLocation) {
    ...
    dataAt = currentNode.data;                      // Store the data to be deleted
    ...
    if (typeof currentNode.next !== "undefined") {
        ...
        currentNode.next.prev = parentNode;
...
DoublyLinkedList.prototype.removeData = function(pData) {
    ...
    while (typeof currentNode !== "undefined") {
        ...
        if (this.compare(currentNode.data, pData) == 0) {
...
DoublyLinkedList.prototype.toString = function() {
    ...
    if (typeof current !== "undefined") {
        // If the current is a correct reference to the first node in the list
        ...
        while (typeof current !== "undefined") {
            ...
            returnString += ", " + current.data;            // Attach data in the node to returnString        
            current = current.next;                         // Move the node to the next in the list
        }
    }
