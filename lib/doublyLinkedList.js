...
var DoublyListNode              = require('./common/doublyListNode');
 ...
 *  </ul>
 */
DoublyLinkedList.prototype.deleteAt = function(pLocation) {
 ...
 *  </ul>
 */
DoublyLinkedList.prototype.deleteData = function(pData) {
 ...
 *  @function           size
 *  @class              DoublyLinkedList
 *  @return             Number                  A Number representing the size of the doubly linked list
 *  @description
 *  <ul>
 *      <li>Returns the size of the doubly linked list, ie number of elements in Doubly Linked List</li>
 *  </ul>
 */
DoublyLinkedList.prototype.size = function() {
    
    return this.size                    // Returns the size of doubly linked list
}
