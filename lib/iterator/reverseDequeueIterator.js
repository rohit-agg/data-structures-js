 ...
 *  </ul>
 */
var ReverseDequeueIterator = function(pDequeue) {
    
    var end = pDequeue.front;
    var values = pDequeue.values;
    var current = pDequeue.rear;

    ReverseDequeueIterator.prototype = {
    ...
    return ReverseDequeueIterator.prototype;
}

// Add ReverseDequeueIterator to module.exports
module.exports = ReverseDequeueIterator;