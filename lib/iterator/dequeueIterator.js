...
var DequeueIterator = function(pDequeue, pOrder) {
    ...
    switch (pOrder) {
        ...
        case DequeueIterator.ID_TRAVERSE_REVERSE:
        ...
        case DequeueIterator.ID_TRAVERSE_ORDER:
...
define(DequeueIterator, 'ID_TRAVERSE_ORDER',        1);         // Original Order, From Front to End
define(DequeueIterator, 'ID_TRAVERSE_REVERSE',      2);         // Reverse Order, From End to Front
