...
Dequeue.prototype.iterator = function(pOrder) {
    ...
    if (typeof pOrder === "undefined")      pOrder = Dequeue._ID_TRAVERSE_ORDER;
...
Dequeue._ID_TRAVERSE_ORDER      = DequeueIterator._ID_TRAVERSE_ORDER;
Dequeue._ID_TRAVERSE_REVERSE    = DequeueIterator._ID_TRAVERSE_REVERSE;
