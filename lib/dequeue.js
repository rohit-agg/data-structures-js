...
var OrderDequeueIterator    = require('./iterator/orderDequeueIterator');
var ReverseDequeueIterator  = require('./iterator/reverseDequeueIterator');
...
Dequeue.prototype.iterator = function(pOrder) {
    ...
    if (pOrder == Dequeue.ID_TRAVERSE_REVERSE) {
        // If the provided order is for Reverse Traversing

        return new OrderDequeueIterator(this);          // Return object of Reverse Traversing

    } else {
        // If the order is not provided, or is invalid or for Normal Order Traversing

        return new ReverseDequeueIterator(this);        // Return object of Order Traversing
    }
}
...
// Define the two Types of Traversal Orders for dequeue
define(Dequeue, 'ID_TRAVERSE_ORDER',        1);         // Original Order, From Front to End
define(Dequeue, 'ID_TRAVERSE_REVERSE',      2);         // Reverse Order, From End to Front
