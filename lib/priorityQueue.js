...
var comparePriority = function(pEle1, pEle2) {
    ...
    if (!(pEle1 instanceof PriorityQueueNode) || !(pEle2 instanceof PriorityQueueNode)) {
        // If either of the two elements are not instance of PriorityQueueNode, mark the two as equal
 ...
 *  </ul>
 */
PriorityQueue.prototype.search = function() {
