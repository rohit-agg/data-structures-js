...
var equals = function(pValue1, pValue2) {
    ...
    if (pValue1 == pValue2) {
    	// If the Value1 is equivalent to value 2, return 0

    	return 0;

    } else if (pValue < pValue2) {
    	// If the value1 is less than value2, return -1

    	return -1;

    } else {
    	// If the value1 is more than value2, return 1
