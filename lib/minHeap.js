 ...
 *  @function           removeMin
 *  @class              MinHeap
 *  @return             Object          Object of the data present on the top of Heap as Minimum value
 *  @description
 *  <ul>
...
MinHeap.prototype.removeMin = function() {
    ...
    minOfHeap = this.size-1;            // Store the current Min of Heap into a variable
    ...
    delete this.values[this.size-1];            // Delete the data present on the last node
    this.size--;                                // Decrement the size of the heap
    sink(this.values, 0, this);                 // Re-adjust the heap to satisfy min-heap property
    
    return minOfHeap;                   // Return the value that was present as Min of Heap
}
